...
public class Menu2 {
        ...
        Start start = new Start();
            // imports all of the strings necessary
        ...
        double price_total = start.price_total;
            // imports the ingredients that are eihter getting removed or staying inside
        ...
        LinkedList<String> menu_list = start.menu_list;
            // shows all the menu list and welcomes the user at the same time
        System.out.println(Welcome_the_user_to_the_restaurant);
        for (String i : menu_list) {
            System.out.println(i);
        }
        System.out.println(" ");
        // asks the user to pick one of the food in the menu list
        System.out.println(choices_for_the_user_to_choose_from);
        System.out.println("");
        // takes and store the answer
        Scanner scanner = new Scanner(System.in); 
        String users_choice_of_food = scanner.nextLine();
        // which food in the menu list did the user wrote?
        ...
        case "0":
            ...
            // if the user said remove ingredient (yes) then asks the user which ingredient do you want to rmeove, if not (no) then we don't remove anything and serves them straight away
            ...
            case "y": 
                ...
                break;
                // anything except yes is going in the default
            default:
                System.out.println(no_removal);
                System.out.println(the_food_is_ready);
                System.out.println(chicken_salad_ingredients);
        ...
        case "3":
            ...
            System.out.println("");
            price_total = price[3];
            String fruit_salad = scanner.nextLine();
            switch (fruit_salad) {
            case "Y":
            case "y":
                System.out.println(asks_user_which_ingredient_should_be_removed);                                
        ...
        scanner.close();
        System.out.println("$"+ price_total); // how much it costed the user
    }
}
